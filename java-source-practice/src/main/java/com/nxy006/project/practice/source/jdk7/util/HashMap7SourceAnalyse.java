package com.nxy006.project.practice.source.jdk7.util;

import java.io.*;
import java.util.*;
import java.util.concurrent.ThreadLocalRandom;

public class HashMap7SourceAnalyse {
...
// 源码修改：
// 1. 修改为包级别类
// 2. final int hash(Object k) 方法原来调用的 Hashing.stringHash32((String) k) 不可用，修改为 s.hashCode() 方法
        ...
        implements Map<K,V>, Cloneable, Serializable
{
    ...
    final int hash(Object k) {
        ...
        if (0 != h && k instanceof String) {
            // [重要] 此处原逻辑依赖 JDK 7，现修改为 s.hashCode() 方法
...
//        return Hashing.Holder.LANG_ACCESS.getStringHash32(var0);
//    }
